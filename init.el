...
v   '(zenburn-theme format-all magit gruber-darker-theme mood-line hide-mode-line all-the-icons-nerd-fonts all-the-icons doom-modeline doom-themes vundo ## avy company flycheck helm-lsp helm-xref hydra lsp-mode projectile yasnippet)))
(custom-set-faces
