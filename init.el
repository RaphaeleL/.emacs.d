...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("013728cb445c73763d13e39c0e3fd52c06eefe3fbd173a766bfd29c6d040f100"
     ...
     "4b026ac68a1vaa4d1a91879b64f54c2490b4ecad8b64de5b1865bca0addd053d9"
     "21e3d55141186651571241c2ba3c665979d1e886f53b2e52411e9e96659132d4"
     default))
 '(package-selected-packages
<<<<<<< HEAD
   '(yasnippet company tree-sitter hydra go-mode rainbow-mode rust-mode markdown-mode ## zenburn-theme super-save smex simpleclip multiple-cursors move-text mood-line magit lsp-pyright hide-mode-line helm-xref helm-lsp gruber-darker-theme format-all)))
=======
   '(## company doom-themes format-all go-mode gruber-darker-theme
	helm-lsp helm-xref hide-mode-line hydra json-mode lsp-pyright
	magit markdown-mode mood-line move-text multiple-cursors
	rainbow-mode rust-mode simpleclip smex super-save tree-sitter
	typescript-mode yasnippet zenburn-theme)))
>>>>>>> 4581dce (Some Updates on my Emacs.)
(custom-set-faces
