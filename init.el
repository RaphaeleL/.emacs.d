...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode ## zenburn-theme yasnippet super-save smex simpleclip projectile multiple-cursors move-text mood-line modus-themes magit lsp-pyright hydra hide-mode-line helm-xref helm-lsp gruber-darker-theme format-all flycheck doom-themes company avy)))
(custom-set-faces
