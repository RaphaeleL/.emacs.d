(custom-set-variables
 ...
 '(package-selected-packages
   '(vundo web-mode lab-themes flucui-themes rpm-spec-mode dockerfile-mode doom-themes markdown-mode ssh theme-changer jenkinsfile-mode xterm-color groovy-mode magit multiple-cursors move-text simpleclip gruber-darker-theme)))
(custom-set-faces
