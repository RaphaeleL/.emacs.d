...
(add-to-list 'auto-mode-alist '("MakePkg" . makefile-mode))

(cond
 ((eq system-type 'windows-nt) (setq default-directory "C:/Users/RaLiccia/" ))
 ((eq system-type 'darwin) (setq default-directory "~/" ))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode modus-themes ansible magit multiple-cursors move-text simpleclip gruber-darker-theme)))
(custom-set-faces
